...
t = time.time()
test = pd.read_csv(os.path.join(os.path.dirname(__file__), 'data_warehouse/test.csv'))
train = pd.read_csv(os.path.join(os.path.dirname(__file__), 'data_warehouse/train.csv'), nrows=10*1e6)
